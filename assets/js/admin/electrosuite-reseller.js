/**
 * ElectroSuite Reseller Admin JS
 */
jQuery(function(){

	jQuery("body").click(function(){
		jQuery('.electrosuite_reseller_error_tip').fadeOut('100', function(){ jQuery(this).remove(); } );
	});
	...
	jQuery('input#electrosuite_reseller_checkbox').change(function() {
		if (jQuery(this).is(':checked')) {
			jQuery('#electrosuite_reseller_input_text').closest('tr').show();
		}
		else {
			jQuery('#electrosuite_reseller_input_text').closest('tr').hide();
		}
	}).change();
