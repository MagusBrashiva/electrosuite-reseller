...
final class ElectroSuite_Reseller {
	...
	public function __construct() {
		...
		add_action( 'init', array( &$this, 'create_block_domain_search_block_init' ) );
	...
	private function register_scripts_and_styles() {
		if ( is_admin() ) {
			...
			wp_localize_script( $this->plugin_slug . '_admin_script', 'electrosuite_reseller_admin_params', apply_filters( 'electrosuite_reseller_admin_params', array(
				...
				'_tab_api' 				=> __( 'API Settings', 'electrosuite-reseller' ),
				'_tab_general' 			=> __( 'General', 'electrosuite-reseller' ),
	 ...
	 */
	public function create_block_domain_search_block_init() {
        /**
        ...
        if ( function_exists( 'wp_register_block_types_from_metadata_collection' ) ) {
            wp_register_block_types_from_metadata_collection( $this->plugin_path() . '/includes/blocks', $this->plugin_path() . '/includes/blocks/blocks-manifest.php' );
            return;
        }
        ...
        if ( function_exists( 'wp_register_block_metadata_collection' ) ) {
            wp_register_block_metadata_collection( $this->plugin_path() . '/includes/blocks', $this->plugin_path() . '/includes/blocks/blocks-manifest.php' );
        }
        /**
         ...
         */
        $manifest_data = require $this->plugin_path() . '/includes/blocks/blocks-manifest.php';
        foreach ( array_keys( $manifest_data ) as $block_type ) {
            // Use plugin_path() method for consistency if available, or adjust path
            register_block_type( $this->plugin_path() . "/includes/blocks/{$block_type}" );
        }
    } // end create_block_domain_search_block_init method
