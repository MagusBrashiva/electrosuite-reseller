...
final class ElectroSuite_Reseller {
	...
	public function create_block_domain_search_block_init() {
		...
		if ( function_exists( 'wp_register_block_types_from_metadata_collection' ) ) {
			wp_register_block_types_from_metadata_collection( __DIR__ . '/includes/blocks', __DIR__ . '/includes/blocks/blocks-manifest.php' );
			return;
		}
		...
		if ( function_exists( 'wp_register_block_metadata_collection' ) ) {
			wp_register_block_metadata_collection( __DIR__ . '/includes/blocks', __DIR__ . '/includes/blocks/blocks-manifest.php' );
		}
		/**
		 ...
		 */
		$manifest_data = require __DIR__ . '/includes/blocks/blocks-manifest.php';
		foreach ( array_keys( $manifest_data ) as $block_type ) {
			register_block_type( __DIR__ . "/includes/blocks/{$block_type}" );
		}
	} // end create_block_domain_search_block_init
